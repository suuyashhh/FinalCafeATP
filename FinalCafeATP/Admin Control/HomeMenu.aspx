<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Control/AdminCafeATP.Master" AutoEventWireup="true" CodeBehind="HomeMenu.aspx.cs" Inherits="FinalCafeATP.Admin_Control.HomeMenu" %>
        ...
        <div class="row content">
            ...
            <div class="col-md-4 m-list">
                <a class="yash" href="Burgers.aspx">
                    <img decoding="async" src="../images/HOMEMenu-removebg-preview.png" class="img-fluidd" alt="Burgers"><br />
                    All Foods</a>
            </div>
            <div class="col-md-4 m-list"></div>
        </div>
                        ...
                        <div class='col-md-6'>
                            <div class='card'>
                                <div class='card-body sub'>
                                    ...
                                    <h4 style='float: left'><a href='#'><%# Eval("menu_name") %></a></h4>
