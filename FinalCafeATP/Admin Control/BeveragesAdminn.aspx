<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Control/AdminCafeATP.Master" AutoEventWireup="true" CodeBehind="BeveragesAdminn.aspx.cs" Inherits="FinalCafeATP.Admin_Control.BeveragesAdminn" %>
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Burger Name / Prise</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox runat="server" ID="txtmh" TextMode="Number" CssClass="form-control" Style="border: 1px solid black" placeholder="Food Price*"></asp:TextBox>
                            </div>
