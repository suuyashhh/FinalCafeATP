    ...
    public partial class Slides : System.Web.UI.Page
    {
        ...
        protected void showfooditems()
        {
            try
            {
                ...
                using (conn)
                {
                    using (SqlCommand cmd = new SqlCommand("Select Srno,food,price from sides", conn))
                    {
        ...
        {
            conn.Close();
            SqlCommand cmd = new SqlCommand("insert into sides values (@food,@price)", conn);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Close();
                string qry = "delete from sides where Srno=" + b;
